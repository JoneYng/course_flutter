...
public class PolyvManager {
    public   String TAG = PolyvManager.class.getSimpleName();
...
//		new LoadConfigTask().execute();
        ...
        client.setConfig("0VD6zUa1ZHBGTsTLLE0C36UvhDMIauiB+3eNytz5OEKFoJYfAg5Vp/ZTT8BOS4sk/2fAn5TfXIo4wDC9zWyxmASt3KnCfwbFY2JryWYJ/nvMhWRJ0ZvbvzrEhCyFOLElxhjh4d3haAnVHFZGtIAwng==");
        //使用SDK加密串来配置
