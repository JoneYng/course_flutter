...
import 'package:courseflutter/common/themes.dart';
    ...
    return Scaffold(
      ...
      body: ListView.separated(
          ...
          itemBuilder: (_, index) {
            return InkWell(
                onTap: () => {
                Provider.of<ThemeProvider>(context, listen: false).setTheme(index == 0 ? Themes.SYSTEM : (index == 1 ? Themes.DARK : Themes.LIGHT))
            },
            child: Container(
